...
//       try {
//         const appointments = await dispatch(GetAllAppointments());
//         const eyeScreenings = await dispatch(GetAllEyeScreenings());
//         const checkups = await dispatch(GetAllCheckups());
